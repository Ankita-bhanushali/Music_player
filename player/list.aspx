<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="list.aspx.cs" Inherits="player.list" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server">
            <nav>
                &nbsp;
                <asp:Label ID="Label3" Text='Hello' runat="server"></asp:Label>

                &nbsp;<asp:Button ID="Button1" runat="server" Text="Favourite" OnClick="Button1_Click" />
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="container" ScrollBars="Horizontal">
            ...
            <div>
                ...
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" CssClass="songitem" GridLines="Both" OnItemCommand="DataList1_ItemCommand">
                        ...
                        <table class="auto-style1">
                            <tr>
                                    ...
                                    <table class="auto-style1">
                                        <tr>
                                            <td class="auto-style2">
                                                <span class="songName">
                                                    <asp:Label ID="Label1" runat="server" ForeColor="Black" Text='<%# Eval("music_name") %>'></asp:Label>
                                                </span></td>
                                        </tr>
                                        <tr>
                                            <td class="auto-style2">
                                                <asp:Label ID="Label2" runat="server" ForeColor="Black" Text='<%# Eval("singer") %>'></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="text-align: center">
                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandArgument='<%# Eval("music_name")%>' CommandName="addtowishlist" Height="20px" ImageUrl="~/add.png" OnCommand="ImageButton2_Click" Width="20px" />
                                </td>
                            </tr>
                        </table>
                ...
                <br />
                <br />
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:musicplayerConnectionString %>" OnSelecting="SqlDataSource1_Selecting" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [musiclist]"></asp:SqlDataSource>
                <br />
            </div>
            <br />
        </asp:Panel>
    ...
    <script type="text/javascript">
        ...
        function seek(event) {
            if (seeking) {
                seekslider.value = event.clientX - seekslider;
