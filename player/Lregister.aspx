<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lregister.aspx.cs" Inherits="player.register" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="userid" ErrorMessage="Enter The User ID" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="mobile" ErrorMessage="Enter The Mobile No" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <asp:TextBox ID="mobile" runat="server" TextMode="Phone"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Text="PASSWORD"></asp:Label><br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="pass" ErrorMessage="Enter The PassWord" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <asp:TextBox ID="pass" runat="server" TextMode="Password"></asp:TextBox>
        <br /><br />
        <asp:Label ID="Label5" runat="server" Text="CONFIRM PASSWORD"></asp:Label><br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="repass" ErrorMessage="Enter The PassWord" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <asp:TextBox ID="repass" runat="server" TextMode="Password"></asp:TextBox>
        <br />
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="pass" ControlToValidate="repass" ErrorMessage="PassWord Does Not Match" ForeColor="Red"></asp:CompareValidator>
        <br />
