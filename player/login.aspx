...
<body>
    ...
    <br />
    <br />
    <div class="from" dir="auto">
        <form id="form1" runat="server">
            <br />
            <br />
            <asp:Label ID="UID" runat="server" Text="USER ID"></asp:Label>
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="UIDT" ErrorMessage="Enter The User ID" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="LOGB" runat="server" Text="LOG IN" OnClick="BLOG_Click" BackColor="#0099FF" BorderColor="#99CCFF" ForeColor="#0000CC" />
            <br />
            <br />
            <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red" NavigateUrl="~/clogin.aspx">Login creator</asp:HyperLink>
            <br />
