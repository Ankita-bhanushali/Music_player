<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="crea.aspx.cs" Inherits="player.crea" %>
    ...
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server">
            <nav>
                ...
                &nbsp;<asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Add music" />
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="container" ScrollBars="Horizontal">
            ...
            <div>
                ...
                <br />
                <br />
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:musicplayerConnectionString %>" SelectCommand="SELECT * FROM musiclist" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
                <br />
